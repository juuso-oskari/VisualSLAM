...
set(Easy3D_INCLUDE_DIRS "/home/juuso/cpp_course_visual_slam/libs/Easy3D")
set(Easy3D_LIBRARY_DIRS "/home/juuso/cpp_course_visual_slam/build/lib")
set(Easy3D_AVAILABLE_COMPONENTS "util;core;fileio;kdtree;algo;renderer;gui;viewer")
set(Easy3D_VERSION_STRING "2.5.2")
set(Easy3D_VERSION 2.5.2)
...
if (Easy3D_FIND_COMPONENTS) # user tries to find components
    ...
    elseif (found_components)
        ...
        message(STATUS "Found Easy3D (version '2.5.2'). Found components (${lib_type}): ${found_components}")
    ...
    foreach(component ${Easy3D_AVAILABLE_COMPONENTS})
        set(Easy3D_${component}_FOUND TRUE)
    endforeach()
    message(STATUS "Found Easy3D (version '2.5.2'). Available components (${lib_type}): ${Easy3D_AVAILABLE_COMPONENTS}")
    message(STATUS "Easy3D_INCLUDE_DIRS: ${Easy3D_INCLUDE_DIRS}")
    message(STATUS "Easy3D_LIBRARY_DIRS: ${Easy3D_LIBRARY_DIRS}")
endif ()
